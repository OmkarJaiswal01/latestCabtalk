...
//         // 🔽🔽🔽 CHANGE: Added bufferEnd validation
//         const bufferEnd = ps.bufferEnd ? new Date(ps.bufferEnd) : null;
//         const bufferValid =
//           bufferEnd && !isNaN(bufferEnd.getTime()) ? bufferEnd > nowIST : true;
//         // 🔼🔼🔼 CHANGE END
...
//           today,
//           boarded,
//           bufferEnd,       // 🔽 Added for debug
//           bufferValid,     // 🔽 Added for debug
//           included: includeToday && !boarded && bufferValid, // 🔽 Now checks bufferValid too
//           reason: !includeToday
//             ? `today (${today}) not in wfoDays`
//             : boarded
//             ? "already boarded"
//             : !bufferValid
//             ? "bufferEnd passed" // 🔽 New exclusion reason
//             : "included ✅",
//         });

//         // 🔽🔽🔽 CHANGE: Now exclude passengers whose bufferEnd has passed
//         return includeToday && !boarded && bufferValid;
//         // 🔼🔼🔼 CHANGE END
//       })
//       .map((ps) => ({
//         title: formatTitle(
